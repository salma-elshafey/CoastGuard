...
public class Node {
    ...
    //Object[][] state;
    HashMap<int[], Object> occupiedCells;
    ...
    int cols;
    //int heuristic;
    public Node(HashMap<int[], Object> OccupiedCells, Agent agent, Node parent, int depth, int pathCost, String operator, int retrievedBoxes, int deathsSoFar, int rows, int cols){
    ...
    public Node(HashMap<int[], Object> OccupiedCells, Agent agent, Node parent, int depth, int pathCost, String operator, int retrievedBoxes, int deathsSoFar){
        // State is on the form <agent X location, agent Y location>
        this.occupiedCells = OccupiedCells;
        this.agent = agent;
        this.parent = parent;
