...
public class Node2 {
    ...
    int depth;
    int pathCost;
    String agent; // "locX,locY,capacity,availableSeats"
    int rows;
    int cols;
    //int heuristic;
    public Node2(HashMap<String, String> occupiedCells, String agent, Node2 parent, int depth, int pathCost, String operator,
